                ...
                <div class="card item-hasil p-3">
                    <div class="d-flex">
                        <div class="foto-kendaraan">
                            <img src="${data.foto_kendaraan}" alt="">
                        </div>
                        <div class="konten-tengah">
                            <h3> ${data.nama_kendaraan}</h3>
                            <p class="pt-4"> ${data.transmisi}</p>
                            <p><i class="material-icons">airline_seat_recline_normal</i> ${data.penumpang} orang</p>
                            <p> ${data.barang} Koper</p>
                            <p><i class="material-icons">ac_unit</i> AC ${data.isAC}</p>
                        </div>
                        <div class="konten-kanan">
                            <p>Pemilik : ${data.pemilik}</p>
                            <p>Alamat : ${data.alamat}</p>
                            <p><span class="harga-sewa"> ${data.BiayaPerHAri} -</span> / hari</p>
                            <p> ${data.posisi}</p>
...
export default createCariKendaraanTemplate;
